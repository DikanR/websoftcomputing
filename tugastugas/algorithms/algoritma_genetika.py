...
# -----------------------------
def genetic_algorithm(pop_size=10, generations=10, crossover_rate=0.8, mutation_rate=0.1, items={}, capacity=0, elitism=True):
    ...
    for gen in range(generations):
        ...
        temp_list['generasi'] = gen+1
        temp_list['kromosom'] = best_chrom
        temp_list['item'] = best_items
        temp_list['berat'] = w
        temp_list['nilai'] = v
        temp_list['fitness'] = best_fit
    ...
    best_result['kromosom'] = best_chrom
    best_result['item'] = best_items
    best_result['berat'] = w
    best_result['nilai'] = v
    best_result['fitness'] = best_fit
...
# if __name__ == '__main__':
    # random.seed(42)  # agar hasil replikasi konsisten
